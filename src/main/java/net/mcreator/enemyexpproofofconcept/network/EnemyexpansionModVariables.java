...
public class EnemyexpansionModVariables {
	...
	public static class MapVariables extends SavedData {
		...
		public boolean increaseddripstonetarantulas = true;
		...
		public void read(CompoundTag nbt) {
			increaseddripstonetarantulas = nbt.getBoolean("increaseddripstonetarantulas");
		}

		@Override
		public CompoundTag save(CompoundTag nbt) {
			nbt.putBoolean("increaseddripstonetarantulas", increaseddripstonetarantulas);
			return nbt;
		}
