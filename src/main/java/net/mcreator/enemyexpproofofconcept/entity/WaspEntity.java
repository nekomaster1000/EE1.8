...
public class WaspEntity extends Monster implements IAnimatable {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.MONSTER).add(new MobSpawnSettings.SpawnerData(EnemyexpansionModEntities.WASP.get(), 40, 1, 5));
	}
	...
	public void playerTouch(Player sourceentity) {
		...
		WaspStingHitProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this, sourceentity);
	}
